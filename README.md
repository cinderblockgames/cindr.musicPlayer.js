...
A plain-JavaScript, no-external-references, music-player-management library, a demo of which can be found [here](https://cinderblockgames.github.io/cindr.musicPlayer.js/).
